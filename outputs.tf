...
output "data_protection_backup_instance_kubernetes_clusters_backup_datasource_parameters" {
  ...
  value       = { for k, v in azurerm_data_protection_backup_instance_kubernetes_cluster.data_protection_backup_instance_kubernetes_clusters : k => v.backup_datasource_parameters if v.backup_datasource_parameters != null && length(v.backup_datasource_parameters) > 0 }
}
